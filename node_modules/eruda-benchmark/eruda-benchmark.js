/*! eruda-benchmark v2.0.0 https://github.com/liriliri/eruda-benchmark#readme */
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["erudaBenchmark"] = factory();
	else
		root["erudaBenchmark"] = factory();
...
var _defBench = __webpack_require__(95);

var _defBench2 = _interopRequireDefault(_defBench);

var _lodash = __webpack_require__(96);

var _lodash2 = _interopRequireDefault(_lodash);

var _process = __webpack_require__(98);
...
var benchmark = __webpack_require__(99);
var Benchmark = benchmark.runInContext({ _: _lodash2.default, process: _process2.default });
window.Benchmark = Benchmark;

module.exports = function (eruda) {
  var _eruda$util = eruda.util,
      evalCss = _eruda$util.evalCss,
      each = _eruda$util.each,
      $ = _eruda$util.$,
      isArr = _eruda$util.isArr;

  var BenchmarkTool = function (_eruda$Tool) {
    (0, _inherits3.default)(BenchmarkTool, _eruda$Tool);

    function BenchmarkTool() {
      (0, _classCallCheck3.default)(this, BenchmarkTool);

      var _this = (0, _possibleConstructorReturn3.default)(this, (BenchmarkTool.__proto__ || (0, _getPrototypeOf2.default)(BenchmarkTool)).call(this));

      _this.name = 'benchmark';
      _this._style = evalCss(__webpack_require__(100));
      _this._tpl = __webpack_require__(102);

      _this._benches = [];
      return _this;
    }

    (0, _createClass3.default)(BenchmarkTool, [{
      key: 'init',
      value: function init($el, container) {
        (0, _get3.default)(BenchmarkTool.prototype.__proto__ || (0, _getPrototypeOf2.default)(BenchmarkTool.prototype), 'init', this).call(this, $el, container);
      ...
      key: 'show',
      value: function show() {
        (0, _get3.default)(BenchmarkTool.prototype.__proto__ || (0, _getPrototypeOf2.default)(BenchmarkTool.prototype), 'show', this).call(this);
      }
    }, {
      key: 'hide',
      value: function hide() {
        (0, _get3.default)(BenchmarkTool.prototype.__proto__ || (0, _getPrototypeOf2.default)(BenchmarkTool.prototype), 'hide', this).call(this);
      }
    }, {
      key: 'destroy',
      value: function destroy() {
        (0, _get3.default)(BenchmarkTool.prototype.__proto__ || (0, _getPrototypeOf2.default)(BenchmarkTool.prototype), 'destroy', this).call(this);
      ...
      key: '_addBenchSuite',
      value: function _addBenchSuite(name, fns) {
        var benches = this._benches;
      ...
      key: '_addBench',
      value: function _addBench(name, fn) {
        var benches = this._benches;
      ...
      value: function _render() {
        ...
        this._$el.html(this._tpl({ benches: benches }));
      ...
      key: '_updateResult',
      value: function _updateResult(bench, result) {
        var benches = this._benches;

        var i = 0;
        for (var len = benches.length; i < len; i++) {
      ...
      key: '_addDefBench',
      value: function _addDefBench() {
        var _this2 = this;

        each(_defBench2.default, function (_ref2) {
          var name = _ref2.name,
              fn = _ref2.fn;
          return _this2.add(name, fn);
        });
      }
    }, {
      key: '_bindEvent',
...
// module
exports.push([module.i, ".eruda-dev-tools .eruda-tools .eruda-benchmark {\n  padding: 10px;\n  overflow-y: auto;\n  -webkit-overflow-scrolling: touch; }\n  .eruda-dev-tools .eruda-tools .eruda-benchmark li {\n    padding: 10px;\n    margin-bottom: 10px;\n    border: 1px solid var(--border); }\n    .eruda-dev-tools .eruda-tools .eruda-benchmark li .eruda-title {\n      font-size: 16px;\n      color: var(--accent);\n      padding-bottom: 10px;\n      border-bottom: 1px solid var(--border);\n      position: relative; }\n    .eruda-dev-tools .eruda-tools .eruda-benchmark li .eruda-title,\n    .eruda-dev-tools .eruda-tools .eruda-benchmark li .eruda-result,\n    .eruda-dev-tools .eruda-tools .eruda-benchmark li .eruda-btn {\n      margin: 10px; }\n    .eruda-dev-tools .eruda-tools .eruda-benchmark li .eruda-result-item {\n      margin: 10px 0; }\n    .eruda-dev-tools .eruda-tools .eruda-benchmark li .eruda-result-item-name {\n      display: inline-block;\n      color: var(--accent); }\n    .eruda-dev-tools .eruda-tools .eruda-benchmark li .eruda-result-number {\n      display: inline;\n      color: var(--accent); }\n    .eruda-dev-tools .eruda-tools .eruda-benchmark li .eruda-status {\n      background: var(--darker-background);\n      color: var(--foreground);\n      position: absolute;\n      right: 0;\n      padding: 2px;\n      font-size: 12px; }\n    .eruda-dev-tools .eruda-tools .eruda-benchmark li .eruda-btn {\n      background: var(--darker-background);\n      cursor: pointer;\n      -webkit-transition: background 0.3s;\n      transition: background 0.3s;\n      color: var(--foreground);\n      padding: 10px;\n      text-align: center; }\n      .eruda-dev-tools .eruda-tools .eruda-benchmark li .eruda-btn:active {\n        color: var(--select-foreground);\n        background: var(--highlight); }\n      .eruda-dev-tools .eruda-tools .eruda-benchmark li .eruda-btn.eruda-disabled {\n        background: var(--highlight); }\n        .eruda-dev-tools .eruda-tools .eruda-benchmark li .eruda-btn.eruda-disabled:active {\n          background: var(--highlight); }\n", ""]);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <li>\n            <h2 class=\"eruda-title\">"
    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data,"loc":{"start":{"line":4,"column":36},"end":{"line":4,"column":44}}}) : helper)))
    + "<span class=\"eruda-status\">"
    + alias4(((helper = (helper = helpers.status || (depth0 != null ? depth0.status : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"status","hash":{},"data":data,"loc":{"start":{"line":4,"column":71},"end":{"line":4,"column":81}}}) : helper)))
    + "</span></h2>\n            <div class=\"eruda-result\" data-idx=\""
    + alias4(((helper = (helper = helpers.key || (data && data.key)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"key","hash":{},"data":data,"loc":{"start":{"line":5,"column":48},"end":{"line":5,"column":56}}}) : helper)))
    + "\">"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.result : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":5,"column":58},"end":{"line":5,"column":91}}})) != null ? stack1 : "")
    + "</div>\n            <div class=\"eruda-btn "
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.isRunning : depth0),{"name":"if","hash":{},"fn":container.program(4, data, 0),"inverse":container.program(6, data, 0),"data":data,"loc":{"start":{"line":6,"column":34},"end":{"line":6,"column":89}}})) != null ? stack1 : "")
    + "\" data-idx=\""
    + alias4(((helper = (helper = helpers.key || (data && data.key)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"key","hash":{},"data":data,"loc":{"start":{"line":6,"column":101},"end":{"line":6,"column":109}}}) : helper)))
    + "\">Run</div>\n        </li>\n";
},"2":function(container,depth0,helpers,partials,data) {
    var stack1, helper;

  return ((stack1 = ((helper = (helper = helpers.result || (depth0 != null ? depth0.result : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"result","hash":{},"data":data,"loc":{"start":{"line":5,"column":72},"end":{"line":5,"column":84}}}) : helper))) != null ? stack1 : "");
},"4":function(container,depth0,helpers,partials,data) {
    return "eruda-disabled";
  ...
  return "<ul>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.benches : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":2,"column":4},"end":{"line":8,"column":13}}})) != null ? stack1 : "")
    + "</ul>";
},"useData":true});
